...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item Piętro 1: programiści i testerzy, serwerownia pocztowa, serwerownia www
...
W tabeli sumowane są wartości przepływów lokalnych dla każdego użytkownika. Wartości są w kb/s.
\newline
\begin{tabular}{|c|c|c|} \hline
	& down & up \\
	\hline
